...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,toolbars:[
            ['Undo', 'Redo', 'Bold', 'Italic', 'Underline', 'StrikeThrough', 'Superscript', 'ForeColor', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'InsertOrderedList', 'Link', 'Unlink', 'InsertImage', 'scrawl', 'ImageLeft', 'ImageCenter', 'ImageRight', 'InsertTable', 'DeleteTable', 'Preview']
        ]
        //当鼠标放在工具栏上时显示的tooltip提示
        ,labelMap:{
            'undo':'撤销','redo':'重做','bold':'加粗','italic':'斜体','underline':'下划线','strikethrough':'删除线','superscript':'上标','forecolor':'文字颜色','justifyleft':'居左对齐','justifycenter':'居中对齐','justifyright':'居右对齐','insertorderedlist':'插入有序列表','link':'插入链接','unlink':'取消链接','insertimage':'插入图片','scrawl':'插入涂鸦','imageleft':'图片居左','imagecenter':'图片居中','imageright':'图片居右','inserttable':'插入表格','deletetable':'删除表格','preview':'预览'
        }
